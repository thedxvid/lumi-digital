...
export const SignInPage: React.FC<SignInPageProps> = ({
  ...
  return (
    <div className="h-[100dvh] flex flex-col md:flex-row w-[100dvw]">
          ...
          <div className="flex flex-col gap-6">
            ...
            <form className="space-y-5" onSubmit={onSignIn}>
              ...
              <div className="animate-element animate-delay-500 flex items-center justify-between text-sm">
                ...
                <a href="#" onClick={(e) => { e.preventDefault(); onResetPassword?.(); }} className="hover:underline text-primary transition-colors">Esqueceu a senha?</a>
              </div>
      ...
      {(heroComponent || heroImageSrc) && (
        <section className="hidden md:block flex-1 relative p-4">
          {heroComponent ? (
            <div className="animate-element animate-delay-300 absolute inset-4 rounded-3xl overflow-hidden">
              {heroComponent}
            </div>
          ) : (
            <div className="animate-element animate-delay-300 absolute inset-4 rounded-3xl bg-cover bg-center" style={{ backgroundImage: `url(${heroImageSrc})` }}></div>
          )}
